<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="https://images.chesscomfiles.com/uploads/v1/images_users/tiny_mce/VInfinite017/phpo1DxRH.jpeg" alt="Abhay Anand" class="img-circle profile-img" width="100" height="100">
                                <h6 class="title">Abhay Anand</h6>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-cyan">
                                    ...
                                    <li class="nav-header">
                                        <span class="">Accessiblity</span>
                                    </li>
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Classes Data</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
  ...
  <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Subjects Data</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
   ...
   <li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Students Data </span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
...
<li class="has-children">
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>Results Data</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
